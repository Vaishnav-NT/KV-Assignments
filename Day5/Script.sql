...
(id, shipment_address_id, ser_id)
VALUES(uuid_generate_v4(), (select id from address where "pincode"='123'), (select id from user where "name"='abc')),
(uuid_generate_v4(), (select id from address where "pincode"='123'), (select id from user where "name"='abc')),
(uuid_generate_v4(), (select id from address where "pincode"='123'), (select id from user where "name"='abc')),
(uuid_generate_v4(), (select id from address where "pincode"='454'), (select id from user where "name"='ghi')),
(uuid_generate_v4(), (select id from address where "pincode"='454'), (select id from user where "name"='ghi'));


INSERT INTO public.order_product
(order_id, product_id, quantity, price)
VALUES('e4bc5e61-ca5f-46a9-859c-a3d9160fcac3', '0e86384b-9121-4a84-9de5-22848b225cdd', 1, 4000),
('e4bc5e61-ca5f-46a9-859c-a3d9160fcac3', 'e00aa51a-271e-4776-9a80-7a4c04258e0c', 2, 20000),
('73c0d367-2258-40ee-87e1-f30f32b7f45e', '2fdc15ac-6e5e-482a-a53c-304b90ee92ed', 1, 50000),
('9b4124b5-1117-4709-83a8-6372b96a8ce3', 'bdfa1233-c899-4635-8962-714e488fae23', 4, 450),
('20d14ec8-bb86-4512-b03f-cb92259b6ac3', '0e86384b-9121-4a84-9de5-22848b225cdd', 1, 10000),
('20d14ec8-bb86-4512-b03f-cb92259b6ac3', 'bdfa1233-c899-4635-8962-714e488fae23', 3, 300),
('71da0261-a175-463d-bae6-a690000e9dc2', '3ad1cd4e-3626-490d-9d77-e1f3fe9c92da', 1, 5000);
